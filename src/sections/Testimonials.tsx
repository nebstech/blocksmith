...
const testimonials = [
  ...
  {
    text: 'The intergration process was seamless and the performance improvements were beyond our expectations',
    name: 'Harry Bender',
              ...
              className={twMerge(
                ...
                <cite className="block mt-8">
                  ...
                  <div>
                    ...
                    <div className="not-italic text-zinc-400">{testimonial.title}</div>
                  </div>
                </cite>
              </motion.blockquote>
          ))}
